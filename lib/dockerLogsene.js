    ...
    if ((Date.now() - logObject['@timestamp'].getTime()) < (maxAge)) {
      ...
      logToLogsene(
        ...
        messageString,
        {
          ...
          dockerImageName: logObject.image_name,
          dockerContainerName: logObject.container_name,
          k8sNamespace: logObject.kubernetes.namespace,
          k8sPodName: logObject.kubernetes.pod_name,
        }
      );
    }
  }
